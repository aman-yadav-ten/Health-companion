...
from .app_context import app, login_required
...
def register_routes():
    ...
    app.add_url_rule('/forgot-password', endpoint='forgot_password', view_func=auth_routes.forgot_password, methods=['GET', 'POST'])
    ...
    app.add_url_rule('/calculate-bmi', endpoint='calculate_bmi', view_func=login_required(assessment_routes.calculate_bmi), methods=['GET', 'POST'])
    app.add_url_rule(
        '/calculate-calories',
